 ...
 */
class BOMBEREDITOR_API FBmrGameStateTagCustomization : public FGameplayTagCustomizationPublic
{
public:
	...
	static void RegisterGameStateTagCustomization();

	/** Removes customization for the Game State Tag. */
	static void UnregisterGameStateTagCustomization();
};
