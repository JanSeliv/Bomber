 ...
 */
UCLASS()
class MYEDITORUTILS_API UMyUserWidgetBlueprint : public UWidgetBlueprint
{
	GENERATED_BODY()
 ...
 */
UCLASS(Abstract)
class MYEDITORUTILS_API UMyUserWidgetFactory : public UFactory
{
	GENERATED_BODY()

public:
	UMyUserWidgetFactory();
 ...
 * Basically, is taken from FAssetTypeActions_WidgetBlueprint since we can't derive to private include
 */
class MYEDITORUTILS_API FAssetTypeActions_MyUserWidget : public FAssetTypeActions_Base
{
public:
...
#pragma endregion OverrideInChild
	...
	virtual UClass* GetSupportedClass() const override { return UMyUserWidgetBlueprint::StaticClass(); }
